...
## Обзор проекта
В данном репозитории представлена высокопроизводительная поисковая система, оптимизированная для экосистемы VK Workspace.
...
*   **разреженные эмбеддинги**: FastEmbed BM25;
